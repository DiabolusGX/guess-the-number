...
type GameRepository interface {
	...
	Finish(ctx context.Context, gameID, wonBy string, points, guesses int) error
	GetGameByChannelID(ctx context.Context, channelID string) (*Game, error)
	...
	DisableGame(ctx context.Context, gameID string, guesses int) error
	GetBotLeaderboard(ctx context.Context, startDate, endDate time.Time) ([]Game, error)
}
